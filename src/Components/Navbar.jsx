      ...
      <div className="w-full border px-[200px]">
        <div className="flex justify-between items-center p-[20px]">
          <div className="flex gap-[20px] items-center">
            ...
            <Link className=" hover:text-blue-700" to="/shop">
              Shop
            </Link>
            <Link className=" hover:text-blue-700" to="/product">
              Product
            </Link>
            <Link className=" hover:text-blue-700" to="/pages">
              Pages
            </Link>
            <Link className=" hover:text-blue-700" to="/about">
              About
            </Link>
          </div>
